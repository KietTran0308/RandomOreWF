...
use pocketmine\block\{Block, Cobblestone, Water, Fence, IronOre, DiamondOre, EmeraldOre, GoldOre, CoalOre, LapisOre, RedstoneOre, Stone};
...
class Main extends PluginBase implements Listener{
    ...
    public function onEnable(): void{
        ...
        $this->getLogger()->info("§c§l\|/ §aPLUGIN Random Ore Water Với Fence Đã Bật \|/");
